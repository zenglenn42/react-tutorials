...
import { App as BaHooksUseState4 } from '../../tutorials/benawad-hooks/useState/4-granular-state/App'
import { App as BaHooksUseState5 } from '../../tutorials/benawad-hooks/useState/5-name-pw/App'
import { App as BaHooksUseState6 } from '../../tutorials/benawad-hooks/useState/6-useForm/App'

import { App as BaHooksUseEffect1 } from '../../tutorials/benawad-hooks/useEffect/1-every-render/App'
import { App as BaHooksUseEffect2 } from '../../tutorials/benawad-hooks/useEffect/2-cond/App'
import { App as BaHooksUseEffect3 } from '../../tutorials/benawad-hooks/useEffect/3-once/App'
import { App as BaHooksUseEffect4 } from '../../tutorials/benawad-hooks/useEffect/4-cleanup/App'
import { App as BaHooksUseEffect5 } from '../../tutorials/benawad-hooks/useEffect/5-cleanup-dep/App'
import { App as BaHooksUseEffect6 } from '../../tutorials/benawad-hooks/useEffect/6-events/App'
import { App as BaHooksUseEffect7 } from '../../tutorials/benawad-hooks/useEffect/7-call-api/App'
import { App as BaHooksUseEffect8 } from '../../tutorials/benawad-hooks/useEffect/8-localstorage/App'

import { App as BaHooksUseLayoutEffect1 } from '../../tutorials/benawad-hooks/useLayoutEffect/1-measure-input-field/App'
import { App as BaHooksUseLayoutEffect2 } from '../../tutorials/benawad-hooks/useLayoutEffect/2-dynamic-length/App'
import { App as BaHooksUseLayoutEffect3 } from '../../tutorials/benawad-hooks/useLayoutEffect/3-custom-hook/App'

import { App as BaHooksUseRef1 } from '../../tutorials/benawad-hooks/useRef/1-form-focus/App'
import { App as BaHooksUseRef2 } from '../../tutorials/benawad-hooks/useRef/2-ivar/App'
import { App as BaHooksUseRef3 } from '../../tutorials/benawad-hooks/useRef/3-setState-fail/App'
import { App as BaHooksUseRef4 } from '../../tutorials/benawad-hooks/useRef/4-setState-win/App'

import { AppRouter as BaUseContext0 } from '../../tutorials/benawad-hooks/useContext/0-router-base/AppRouter'
import { AppRouter as BaUseContext1 } from '../../tutorials/benawad-hooks/useContext/1-read-msg/AppRouter'
...
import { App as MaterialUIIntro4 } from '../../tutorials/sistilli-material-ui/1-intro/App4'

import { App as MaterialUIUXCode1 } from '../../tutorials/sistilli-material-ui/2-uiux/1-starter/App'
import { App as MaterialUIUXCode2 } from '../../tutorials/sistilli-material-ui/2-uiux/2-app-layout/App'
import { App as MaterialUIUXCode3 } from '../../tutorials/sistilli-material-ui/2-uiux/3-content-layout/App'
import { App as MaterialUIUXCode4 } from '../../tutorials/sistilli-material-ui/2-uiux/4-header-appbar/App'
import { App as MaterialUIUXCode5 } from '../../tutorials/sistilli-material-ui/2-uiux/5-header-content/App'
import { App as MaterialUIUXCode6 } from '../../tutorials/sistilli-material-ui/2-uiux/6-simple-card/App'
import { App as MaterialUIUXCode7 } from '../../tutorials/sistilli-material-ui/2-uiux/7-content-grid/App'
import { App as MaterialUIUXCode8 } from '../../tutorials/sistilli-material-ui/2-uiux/8-content-card/App'
import { App as MaterialUIUXCode9 } from '../../tutorials/sistilli-material-ui/2-uiux/9-final-products/App'

import { App as MaterialUImakeStyles1 } from '../../tutorials/sistilli-material-ui/3-makeStyles/1-starter/App'
import { App as MaterialUImakeStyles2 } from '../../tutorials/sistilli-material-ui/3-makeStyles/2-makeStyles/App'
import { App as MaterialUImakeStyles3 } from '../../tutorials/sistilli-material-ui/3-makeStyles/3-textStyle/App'
import { App as MaterialUImakeStyles4 } from '../../tutorials/sistilli-material-ui/3-makeStyles/4-props/App'
import { App as MaterialUImakeStyles5 } from '../../tutorials/sistilli-material-ui/3-makeStyles/5-props-multi/App'
import { App as MaterialUImakeStyles6 } from '../../tutorials/sistilli-material-ui/3-makeStyles/6-theme/App'
import { App as MaterialUImakeStyles7 } from '../../tutorials/sistilli-material-ui/3-makeStyles/7-props-and-theme/App'
import { App as MaterialUImakeStyles8 } from '../../tutorials/sistilli-material-ui/3-makeStyles/8-multi-class/App'

import { App as MaterialUIButton1 } from '../../tutorials/sistilli-material-ui/4-button/1-start/App'
import { App as MaterialUIButton2 } from '../../tutorials/sistilli-material-ui/4-button/2-button-docs/App'
import { App as MaterialUIButton3 } from '../../tutorials/sistilli-material-ui/4-button/3-icon-buttons/App'

import { App as MaterialUIText1 } from '../../tutorials/sistilli-material-ui/5-typography/1-props/App'
import { App as MaterialUIText2 } from '../../tutorials/sistilli-material-ui/5-typography/2-override/App'
import { App as MaterialUIText3 } from '../../tutorials/sistilli-material-ui/5-typography/3-theme/App'
import { App as MaterialUIText4 } from '../../tutorials/sistilli-material-ui/5-typography/4-themes/App'

import { App as MaterialUIThemes1 } from '../../tutorials/sistilli-material-ui/6-themes/1-intro/App'
import { App as MaterialUIThemes2 } from '../../tutorials/sistilli-material-ui/6-themes/2-create-theme/App'
import { App as MaterialUIThemes3 } from '../../tutorials/sistilli-material-ui/6-themes/3-breakpoint-style/App'
import { App as MaterialUIThemes4 } from '../../tutorials/sistilli-material-ui/6-themes/4-dark/App'

import { App as MaterialUIPaper1 } from '../../tutorials/sistilli-material-ui/7-paper/1-elevation/App'
import { App as MaterialUIPaper2 } from '../../tutorials/sistilli-material-ui/7-paper/2-square/App'

import { App as MaterialUIDark1 } from '../../tutorials/sistilli-material-ui/8-dark/1-light/App'
import { App as MaterialUIDark2 } from '../../tutorials/sistilli-material-ui/8-dark/2-dark/App'
import { App as MaterialUIDark3 } from '../../tutorials/sistilli-material-ui/8-dark/3-toggle/App'
import { App as MaterialUIDark4 } from '../../tutorials/sistilli-material-ui/8-dark/4-green/App'

import { App as MaterialUITemplateAlbum } from '../../tutorials/sistilli-material-ui/9-templates/album/App'
import { App as MaterialUITemplateBlog } from '../../tutorials/sistilli-material-ui/9-templates/blog/App'
import { App as MaterialUITemplateCheckout } from '../../tutorials/sistilli-material-ui/9-templates/checkout/App'
import { App as MaterialUITemplateDashboard } from '../../tutorials/sistilli-material-ui/9-templates/dashboard/App'
import { App as MaterialUITemplatePricing } from '../../tutorials/sistilli-material-ui/9-templates/pricing/App'
import { App as MaterialUITemplateSignIn } from '../../tutorials/sistilli-material-ui/9-templates/sign-in/App'
import { App as MaterialUITemplateSignInSide } from '../../tutorials/sistilli-material-ui/9-templates/sign-in-side/App'
import { App as MaterialUITemplateSignUp } from '../../tutorials/sistilli-material-ui/9-templates/sign-up/App'
import { App as MaterialUITemplateStickyFooter } from '../../tutorials/sistilli-material-ui/9-templates/sticky-footer/App'

import { App as MaterialUIGrid1 } from '../../tutorials/sistilli-material-ui/10-grid/1-start/App'
import { CenteredGrid as MaterialUIGrid2 } from '../../tutorials/sistilli-material-ui/10-grid/2-doc-start/App'
import { CenteredGrid as MaterialUIGrid3 } from '../../tutorials/sistilli-material-ui/10-grid/3-doc-336/App'
import { CenteredGrid as MaterialUIGrid4 } from '../../tutorials/sistilli-material-ui/10-grid/4-doc-337/App'
import { CenteredGrid as MaterialUIGrid5 } from '../../tutorials/sistilli-material-ui/10-grid/5-doc-xs-vs-sm/App'
import { CenteredGrid as MaterialUIGrid6 } from '../../tutorials/sistilli-material-ui/10-grid/6-spacing/App'
import { CenteredGrid as MaterialUIGrid7 } from '../../tutorials/sistilli-material-ui/10-grid/7-direction/App'
import { CenteredGrid as MaterialUIGrid8 } from '../../tutorials/sistilli-material-ui/10-grid/8-nested/App'
import { CenteredGrid as MaterialUIGrid9 } from '../../tutorials/sistilli-material-ui/10-grid/9-simple-layout/App'

import { App as MaterialUIGridCenter1 } from '../../tutorials/sistilli-material-ui/11-grid-centering/1-start/App'
import { App as MaterialUIGridCenter2 } from '../../tutorials/sistilli-material-ui/11-grid-centering/2-justify/App'
import { App as MaterialUIGridCenter3 } from '../../tutorials/sistilli-material-ui/11-grid-centering/3-alignItems/App'
import { App as MaterialUIGridCenter4 } from '../../tutorials/sistilli-material-ui/11-grid-centering/4-justify-column/App'
import { App as MaterialUIGridCenter5 } from '../../tutorials/sistilli-material-ui/11-grid-centering/5-alignItems-column/App'
import { App as MaterialUIGridCenter6 } from '../../tutorials/sistilli-material-ui/11-grid-centering/6-practice/App'
import { App as MaterialUIGridCenter7 } from '../../tutorials/sistilli-material-ui/11-grid-centering/7-justify-w-size/App'

import { App as MaterialUICard1 } from '../../tutorials/sistilli-material-ui/12-card/1-simple/App'
import { App as MaterialUICard2 } from '../../tutorials/sistilli-material-ui/12-card/2-complex/App'
import { App as MaterialUICard3 } from '../../tutorials/sistilli-material-ui/12-card/3-header/App'
import { App as MaterialUICard4 } from '../../tutorials/sistilli-material-ui/12-card/4-media/App'
import { App as MaterialUICard5 } from '../../tutorials/sistilli-material-ui/12-card/5-content/App'
import { App as MaterialUICard6 } from '../../tutorials/sistilli-material-ui/12-card/6-actions/App'
import { App as MaterialUICard7 } from '../../tutorials/sistilli-material-ui/12-card/7-gridify/App'

import { App as MaterialUITable1 } from '../../tutorials/sistilli-material-ui/13-table/1-simple/App'
import { App as MaterialUITable2 } from '../../tutorials/sistilli-material-ui/13-table/2-enhanced/App'

import { TemporaryDrawer as MaterialUIDrawer1 } from '../../tutorials/sistilli-material-ui/21-drawer/1-docs/App-Temporary'
import { PersistentDrawerLeft as MaterialUIPersistentDrawer1 } from '../../tutorials/sistilli-material-ui/21-drawer/1-docs/App-Persistent'
import { App as MaterialUIDrawer2 } from '../../tutorials/sistilli-material-ui/21-drawer/2-router/App'
import { App as MaterialUIDrawer3 } from '../../tutorials/sistilli-material-ui/21-drawer/3-permanent/App'
import { App as MaterialUIDrawer4 } from '../../tutorials/sistilli-material-ui/21-drawer/4-w-item-icons/App'
...
import { App as AsHooks3 } from '../../tutorials/sistilli-hooks/3-lifecycle/App'
import { App as AsHooks4 } from '../../tutorials/sistilli-hooks/4-useEffect/App'
import { App as AsHooks5 } from '../../tutorials/sistilli-hooks/5-useEffect-2/App'
...
const TutorialData = [
        ...
        playlist: [
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'This nicely paced, 5-hour introduction to React offers plenty of progressive practice.',
                    date: '2018-12-18',
                    author: 'Bob Ziroll',
                    avatars: [
                        <Avatar
        ...
        playlist: [
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'This 30 minute tutorial introduces hooks, a means of adding state to function-based components.',
                    date: '2018-11-15',
        ...
        playlist: [
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        "This spare, 15 minute tutorial introduces React's Context API, a lightweight data store for managing state outside your components.",
                    date: '2018-03-13',
                    author: 'Wes Bos',
                    avatars: [
                        <Avatar
    ...
    },
    {
        summary: {
            ...
            level: 'introductory',
            descText:
                "Ben is primarily a backend developer, but he covers a range of subjects that hit the entire stack.  He generally codes in typescript so if you're wanting to come up to speed on that, there's a bonus. Ben has a stealthy sense of humor and cuts to the chase quickly.",
            date: '2019-01-01',
            author: 'Ben Awad',
            avatars: [
                <Avatar
        ...
        playlist: [
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'This 10 minute typescript-based tutorial introduces React Router, a means of giving your Single Page Applications the usability of multi-page applications without the overhead of separate requests to the server.',
                    date: '2019-09-29',
                    author: 'Ben Awad',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'This tutorial adds people to a Material UI table from state which is being updated from a form.',
                    date: '2019-04-17',
                    author: 'Ben Awad',
                    avatars: [
                        <Avatar
    ...
    },
    {
        summary: {
            ...
            level: 'introductory',
            descText:
                "This is Ben's significant introduction to several different React hooks, the enabling force behind functional components with no class envy.",
            date: '2019-06-22',
            author: 'Ben Awad',
            avatars: [
                <Avatar
        ...
        playlist: [
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'This tutorial introduces useState, a React hook that gives functional components the ability to manage state.',
                    date: '2019-06-29',
                    author: 'Ben Awad',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'This tutorial introduces useState, a React hook for approximately replacing lifecycle methods used by class components.  Several important use-cases are discussed in the tutorial.',
                    date: '2019-06-23',
                    author: 'Ben Awad',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        "This tutorial introduces useRef, a hook useful in forms and a means of storage that doesn't trigger re-renders, unlike useState",
                    date: '2019-06-24',
                    author: 'Ben Awad',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'This tutorial introduces useLayoutEffect, a React hook for reading DOM layout.',
                    date: '2019-06-25',
                    author: 'Ben Awad',
                    avatars: [
                        <Avatar
        ...
        playlist: [
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'Find out where lifecycle methods disappeared to in a hooks-based functional component worldview.',
                    date: '2020-02-20',
        ...
        playlist: [
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'Provides overview of Material UI component library for React',
                    date: '2020-03-08',
                    author: 'Anthony Sistilli',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'Progresses from a Figma design of a product catalog page to a basic frontend implementation.',
                    date: '2020-03-14',
                    author: 'Anthony Sistilli',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    ...
                    level: 'intermediate',
                    descText:
                        "Use the makeStyles hook with props or themes to customize your React components' appearance.",
                    date: '2020-03-21',
                    author: 'Anthony Sistilli',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    ...
                    level: 'intermediate',
                    descText:
                        '<Button> is a ubiquitous component but it does have some subltlety.  Learn about it here.',
                    date: '2020-03-22',
                    author: 'Anthony Sistilli',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'Learn about basic <Typography> properties and override mechanisms.',
                    date: '2020-03-23',
                    author: 'Anthony Sistilli',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    provider: 'Forge Coding',
                    courseTitle:
                        'Material UI #6: Themes - Making your own Theme',
                    demoKey: 'summary',
                    refLink: {
                        tipText: 'youtube',
                    ...
                    level: 'introductory',
                    descText:
                        'Use themes to define a cohesive, overall look to your applications.  The default theme gives you thoughtful values for most attributes, but may be overridden depending upon your design rules.',
                    date: '2020-03-28',
                    author: 'Anthony Sistilli',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'The <Paper> component is really just a div providing a background and a box-shadow.  But it is fundamental. ',
                    date: '2020-03-30',
                    author: 'Anthony Sistilli',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        "Dark mode is the new hotness.  But it's basically already built into Material-UI.  Just use <Paper> and tweak one setting in the default theme to unleash.",
                    date: '2020-04-04',
                    author: 'Anthony Sistilli',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'Material UI comes with a few pre-coded templates for common tasks such as logging in and checkout.  Some of these resources may give you ideas or speed your development.',
                    date: '2020-04-06',
                    author: 'Anthony Sistilli',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        "The <Grid> component can be a bit tricky.  It's helpful to understand that Material UI bases its grid on the flexbox model.",
                    date: '2020-04-11',
                    author: 'Anthony Sistilli',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'Learn more about Grid spacing within containers and especially centering within grid items.  The key is to understand flexbox semantics.',
                    date: '2020-04-21',
                    author: 'Anthony Sistilli',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'Cards are an attractive building block for many designs.  Understand card taxonomy so you can efficiently leverage pre-built properties and sub-components.',
                    date: '2020-04-26',
                    author: 'Anthony Sistilli',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'Tables in Material UI are a complex but capable component.  This tutorial discusses the basics.',
                    date: '2020-05-03',
                    author: 'Anthony Sistilli',
                    avatars: [
                        <Avatar
            ...
            },
            {
                ...
                summary: {
                    ...
                    level: 'introductory',
                    descText:
                        'The drawer component is indispensible and comes in 3 variants, temporary, persistent, and permanent.  In this tutorial, the focus is on the permanent variant along with very useful React Router integration.',
                    date: '2020-06-06',
                    author: 'Anthony Sistilli',
                    avatars: [
                        <Avatar
                ...
                snapshots: [
                    ...
                    },
                    {
                        ...
                        codeLink: {
                            tipText: 'github',
                            href:
                                'https://github.com/zenglenn42/react-tutorials/tree/master/client/src/tutorials/sistilli-material-ui/21-drawer/6-container',
                            icon: <GitHubIcon />
                        },
                    ...
                    },
                    {
                        ...
                        codeLink: {
                            tipText: 'github',
                            href:
                                'https://github.com/zenglenn42/react-tutorials/tree/master/client/src/tutorials/sistilli-material-ui/21-drawer/7-responsive',
                            icon: <GitHubIcon />
                        },
