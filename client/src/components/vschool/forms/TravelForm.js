            ...
            <div>
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <label>Gender <br />
                        ...
                        <label>
                            <input type="radio" name="gender" value="non-binary" checked={this.state.gender === "non-binary"}onChange={this.handleChange}/> non-binary
                        </label>
                    </label>
                    <hr />
                    <label>
                    ...
                    <label>
                        ...
                        <label>
                            <input type="checkbox" name="isVegetarian" checked={this.state.diet.isVegetarian} onChange={this.handleChange}/>
                            Vegetarian
                        </label> <br />
                        <label>
                            <input type="checkbox" name="isKosher" checked={this.state.diet.isKosher} onChange={this.handleChange}/>
                            Kosher
                        </label> <br />
                        <label>
                            <input type="checkbox" name="isLactoseFree" checked={this.state.diet.isLactoseFree} onChange={this.handleChange}/>
                            Lactose free
                        </label> <br />
                    </label>
                    <hr />
