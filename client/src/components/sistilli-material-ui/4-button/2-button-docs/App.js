    ...
    return (
        <>
            ...
            <div>
                ...
                <Button className={classes.buttonSpacing} variant="contained">
                    Default
                </Button>
                <Button
                ...
                <hr />
                <p>variant="text"</p>
                <Button className={classes.buttonSpacing} variant="text">
                    Default
                </Button>
                <Button
                    className={classes.buttonSpacing}
                ...
                <Button className={classes.buttonSpacing} variant="outlined">
                    Default
                </Button>
                <Button
                    className={classes.buttonSpacing}
