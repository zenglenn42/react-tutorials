...
export default function TutorialList(props) {
    ...
    const handleSolutionClick = (e) => {
        ...
        const solution = tutorial.snapshots.filter((solution) => {
            return solution.demoKey === demoKey
        })[0]
    ...
    const getTutorialListItems = (tutorial) => {
        ...
        const collapseListItems = tutorial.snapshots.map((solution) => {
            return (
                <ListItem
                    button
                    data-tutorialkey={primaryText}
                    key={solution.demoKey}
            ...
            return (
                <ListSubheader disableSticky id={pl.primaryText}>
                    <ListItem
                        ...
                        data-demokey={pl.summary.demoKey}
                        onClick={handleExpandClick}
                    >
